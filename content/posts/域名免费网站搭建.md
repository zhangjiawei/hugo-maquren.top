...
keywords: ["域名建站", "Cloudflare Pages 教程", "Hugo 博客搭建", "Giscus 评论", "免费建站教程"]
ShowToc: true
faq:
  - q: "Hugo + Cloudflare Pages 搭建博客是否需要服务器？"
    a: "不需要。静态站点可直接托管在 Cloudflare Pages，结合自定义域名即可上线。"
  - q: "评论功能为什么有时看不到？"
    a: "需先完成评论系统（如 Utterances 或 Giscus）的仓库授权，授权后文章底部即可显示评论区。"
draft: false
---
